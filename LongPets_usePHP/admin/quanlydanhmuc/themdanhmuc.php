    ...
    <div class="app">
        ...
        <div class="container-fluid" style="background-color: #f1f2f7;"> 
                ...
                <div class="col-md-9">
                    ...
                    <div id="toast"></div>   
                    <div class="danhmuc_content" id="noidung">
                        <div class="admin_menu_items" style="width: 200px; position: relative; right: 13px; top:2px;">
                            ...
                            <script>
                                function show(x) {             
                                //window.open("themdanhmuc.php?madanhmuc="+x,"_self"); 
                                var option={'show' : true};
                                
                                $('#myModal_fix').on('show.bs.modal', function (e) {
                                    window.open("themdanhmuc.php?madanhmuc="+x,"_self");
                                    $('#myModal_fix').modal(option);
                                });
                                }
                            </script>
                        ...
                        <table class="table table-bordered" style="margin-top: 15px; font-size: 1.6rem;">
                            ...
                            foreach($danhmucList as $dm) {
                                ...
                                <tr>
                                    <td>'.$dm['madanhmuc'].'</td>
                                    <td>'.$dm['tendanhmuc'].'</td>
                                    <td><a href="" class="danhmuc_fix-icon" data-toggle="modal" data-target="#myModal_fix" onclick="show('.$dm['madanhmuc'].')"><i class="far fa-edit"></i></a></td>
                                    <td><a href="" class="danhmuc_remove-icon"><i class="far fa-trash-alt"></i></a></td>
                                </tr>
                                ';
                            }
                            ?>
