...
if(!empty($_POST)) {
    ...
    $link = "../../assets/img/";
    $sql = "insert into thucung(madanhmuc, tenthucung, gioitinhthucung, tuoithucung, datiemchung, baohanhsuckhoe, tieude, mota, ghichu, hinhanh, soluong, giaban, giamgia) value ('$danhmuc', '$tenthucung', '$gioitinhthucung', '$tuoithucung', '$datiemchung', '$baohanhsuckhoe', '$tieude', '$mota', '$ghichu','$link$hinhanh', '$soluong', '$giaban', '$giamgia')";
    execute($sql);
...
<body>
    ...
    <div  class="container-fluid" style="background-color: #f1f2f7;">
        ...
        <div class="col-sm-9" style="padding-right:0;">
            <div class="themthucung_form">
                <div class="form-row">
                    <h1 class="themthucung_heading">Thêm thú cưng</h1>
                    <div id="toast"></div>  
                </div>
                <div class="form-row">
                    <form action="" method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="form-group" style="padding:0 15px;">
                            ...
                            <input type="text" class="form-control" placeholder="Tên thú cưng" name="tenthucung">
                        </div>
                        <div class="form-row">
                            <div class="form-group col-sm-9" style="padding:0 15px;">
                                <label for="">Tuổi</label>
                                <input type="text" class="form-control" placeholder="Tuổi thú cưng" name="tuoithucung">
                            </div>
                        ...
                        <div class="form-group" style="padding:0 15px;">
                            ...
                            <input type="textarea" class="form-control" placeholder="Tiêu đề" name="tieude">
                        </div>
                        <div class="form-group" style="padding:0 15px;">
                        ...
                        <div class="form-group" style="padding:0 15px;">
                            ...
                            <input type="text" name="spanhinhanh" id="spanhinhanh" style="float: left; width: 500px; border-radius: 4px; border: 1px black solid;" value="">
                            <div style="clear: both;"></div>
                            <img id="hienthianh" src="" class="img-thumbnail" alt="Chưa có hình" width="350px" height="200px"style="background-repeat: no-repeat;background-size: contain;background-position: center;border-top-left-radius: 2px;border-top-right-radius: 2px;">
                        </div>
                        <div class="form-row">
