                    ...
                    <form action="timkiem.php" method="GET" style="width: 850px;">
                        <div class="header__search">
                            <div class="header__search-input-wrap">
                                <input type="text" class="header__search-input" name="timkiemthucung" placeholder="Nhập để tìm kiếm thú cưng VD: Alaska">
            ...
            <div class="grid">
                <div class="grid__row app__content">
                    ...
                    <div class="grid__column-10">
                        ...
                        <?php
                        if(isset($_GET['timkiemthucung'])) {
                            $timkiemthucung = $_GET['timkiemthucung'];
                        }
                        $sql = 'select mathucung, count(mathucung) as number from thucung where tenthucung like "%'.$timkiemthucung .'%"';
                        $result = executeResult($sql);
                        $number = 0;
                        if($result != null && count($result) >0) {
                            $number = $result[0]['number'];
                        ...
                        $sql = "select * from thucung where soluong > 0 and tenthucung like '%$timkiemthucung%' limit $index, 10";
                        $result = executeResult($sql);
                        ...
                        <ul class="pagination home-product__pagination" style="display: flex;">
                            ...
                            if($current_page > 1) {
                                ...
                                <a href="?timkiemthucung=<?=$timkiemthucung?>&?page=<?=$current_page-1?>" class="pagination-item__link">
                            ...
                            for ($i=1; $i <= $pages; $i++) { 
                                ...
                                <a href="?timkiemthucung='.$timkiemthucung.'&?page='.$i.'" class="pagination-item__link">'.$i.'</a>
                                </li>
                                ';
                            }
                            ?>
