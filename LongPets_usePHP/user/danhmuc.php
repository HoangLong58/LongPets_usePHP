            ...
            <div class="grid">
                <div class="grid__row app__content">
                    ...
                    <div class="grid__column-10">
                        <div class="home-filter">
                            ...
                            <div class="home-filter__page">
                                <span class="home-filter__page-num">
                                    <?php
                                    $current_page=1;
                                    $sql = 'select mathucung, count(mathucung) as number from thucung where madanhmuc = '.$madanhmuc.'';
                        ...
                        $sql = 'select * from thucung where madanhmuc = '.$madanhmuc.' limit '.$index.', 10';
                        $result = executeResult($sql);
                        ...
                        <?php
                            if($current_page > 1) {
                                ...
                                <a href="?id=<?=$madanhmuc?>&?page=<?=$current_page-1?>" class="pagination-item__link">
                        ...
                        <?php
                            for ($i=1; $i <= $pages; $i++) { 
                                ...
                                <a href="?id='.$madanhmuc.'&page='.$i.'" class="pagination-item__link">'.$i.'</a>
                                </li>
                                ';
                            }
                        ?>
